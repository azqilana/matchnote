...
export default function () {
  return `
    ...
    <div id="halaman-panduan" class="hidden">
      <div class="konten-panduan">
        ...
        <div class="isi-scroll-panduan">
          ...
          <p>Anda dapat menulis catatan dan menjadikannya kalkulator langsung.</p>
          ...
          <h4>Cara Menghitung (Format):</h4>
          <div class="kotak-contoh">
            <strong>Cara 1 (Baris Tunggal):</strong><br>
            <code>1+1</code><br>
            <small>*Akan muncul tooltip memberikan jawaban.</small>
          </div>
          <div class="kotak-contoh">
            <strong>Cara 2 (Hitung Belanjaan):</strong><br>
            <code>Ayam : 15000<br>Mie : 7000<br>+=</code><br>
            <small>*Ketik tanda operasi diikuti tanda sama dengan (+=, -=, ×=, ÷=)</small>
          </div>
        </div>
    ...
    <section id="daftar-catatan" class="kotak-tema daftar-catatan">
      ...
      <p id="copyright">&copy; Arjuna Arc</p>
    </section>
